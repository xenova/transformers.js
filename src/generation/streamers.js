...
/**
 * Special text streamer to be used with the BuiltInTextGenerationPipeline.
 */
export class RawTextStreamer extends BaseStreamer {
    /**
     * 
     * @param {function(string): void} callback_function 
     */
