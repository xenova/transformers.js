...
const IS_BUILT_IN_AI_AVAILABLE = IS_BROWSER_ENV && 'ai' in self;
...
export const apis = Object.freeze({
    ...
    /** Whether the experimental [built-in AI](https://developer.chrome.com/docs/ai/built-in) API is available */
    IS_BUILT_IN_AI_AVAILABLE,
