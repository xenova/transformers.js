...
One way to do this is to call the running process with the environment variable set. For example, let's say you have a file called `llama.js` with the following code:
