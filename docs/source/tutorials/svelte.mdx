...
On installation, you'll see various prompts.
For this demo, we'll be selecting a simple project skeleton without TypeScript and additional packages for ESLint, Prettier and Tailwind CSS.
